...
class TaskHistoryManager:
    ...
    def add_task(self, task: TaskHistoryItem) -> TaskHistoryItem:
        ...
        # 检查是否已存在
        existing_index = next((i for i, t in enumerate(tasks) if t.task_id == task.task_id), None)
    ...
    def get_all_tasks(self, task_type: Optional[str] = None, pinned_only: bool = False) -> List[TaskHistoryItem]:
        """
        获取所有任务
