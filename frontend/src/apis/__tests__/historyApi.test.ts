...
import type { TaskHistoryItem, CreateTaskHistoryRequest } from '@/types/history'
...
describe('History API', () => {
  ...
  describe('getTaskHistoryList', () => {
    ...
    it('calls the correct endpoint with parameters', async () => {
      ...
      expect(request.get).toHaveBeenCalledWith('/history/tasks?task_type=custom&pinned_only=true')
    })
  })
  ...
  describe('updateTaskHistory', () => {
    it('calls the correct endpoint with update data', async () => {
      ...
      expect(request.patch).toHaveBeenCalledWith('/history/tasks/test_id', updateData)
      expect(result).toEqual(mockResponse)
    })
  })
  ...
  describe('toggleTaskPin', () => {
    it('calls the correct endpoint for toggling pin', async () => {
      ...
      expect(request.post).toHaveBeenCalledWith('/history/tasks/test_id/toggle-pin')
      expect(result).toEqual(mockResponse)
    })
  })
