...
const mockedPerformWebSearch = performWebSearch as Mock;
...
describe("SearchInterface", () => {
	...
	it("handles search form submission", async () => {
		...
		mockedPerformWebSearch.mockResolvedValue(mockResponse);
...
describe("SearchInterface Integration", () => {
	...
	it("handles API errors gracefully", async () => {
		...
		mockedPerformWebSearch.mockRejectedValue(mockError);
